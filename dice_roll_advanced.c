...
void numberOfDiceToRoll(struct Histogram* hist, struct ThePlayers* players, struct Options* optionSettings){
    int i = 0, j = 0, k = 0, m = 0;
    int sum = 0, rollResult = 0, sumCounter = 0, playerCounter = 0, whoseTurn = 0;
    int numberOfDiceToRoll = 0, keypress = 0;
